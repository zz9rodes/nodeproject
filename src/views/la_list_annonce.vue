...
export default{
    ...
    const route = useRouter()
     ...
     var status=ref()
      const Se_Connecter = ()=> {
        axios.get('http://192.168.2.5:3001/List_annonce',{withCredentials:true})
            .then(response=>{
     ...
     <div id="doc">
        ...
        <section id="section" >
            ...
            <div v-for="annonce in annonces" id="annonces">
                <div class="annonce">
                    <RouterLink :to="'/postuler?title=' + annonce.titre+'&id='+annonce.id+'&description='+annonce.description+'&budget='+annonce.budget+'&date='+annonce.date+'&domaine='+annonce.domaine+'&email='+annonce.email" style="text-decoration: none;">
                  
                        <div class="rows"> 
                        <h1 id="titre">{{ annonce.titre }} autre ici</h1>
